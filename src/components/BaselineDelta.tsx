    ...
    <section className="section-block baseline-section">
      ...
      <div className="signal-grid">
        {(Object.keys(signalMeta) as SignalKey[]).map((key) => {
          ...
          const relative = item.ready ? item.relativeDelta : null;
          const baselineValue = item.ready ? item.baseline : null;
            ...
            <div className="signal-row" key={key}>
              ...
              <div className="signal-copy">
                ...
                <div className="signal-values">
                  ...
                  <span>平时 {item.ready ? formatValue(key, baselineValue, meta.unit) : "—"}</span>
                </div>
